...
ZC25ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => ($1.stage.addChild($2)),
ZC29ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => ($1.anchor.set($2)),
ZC30ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1) => (blip($1)),
ZC32ZCtestzm0zi3zi0zi0zminplaceZCLibZC: () => (blip()),
ZC33ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1) => (PIXI.Texture[$1]),
ZC37ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1) => (new PIXI.Sprite($1)),
ZC38ZCtestzm0zi3zi0zi0zminplaceZCLibZC: async ($1) => {const texture = await Assets.load($1); return texture},
ZC40ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => (document.querySelector($1).appendChild($2.canvas)),
ZC42ZCtestzm0zi3zi0zi0zminplaceZCLibZC: async ($1,$2,$3) => {const r = await $1.init({background: $2, resizeTo: document.querySelector($3), preference: "webgl"});
return $1},
ZC44ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => (new PIXI.Text({text: $1, style: {fill: $2 }})),
ZC45ZCtestzm0zi3zi0zi0zminplaceZCLibZC: () => (new PIXI.Application()),
...
ZC3ZCghczminternalZCGHCziInternalziWasmziPrimziImportsZC: ($1,$2) => ($1.then(res => __exports.rts_promiseResolveFloat($2, res), err => __exports.rts_promiseReject($2, err))),
