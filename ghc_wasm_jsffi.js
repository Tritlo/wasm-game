...
ZC22ZCtestzm0zi3zi0zi0zminplaceZCLibZC: () => (blip()),
ZC23ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1) => (PIXI.Texture[$1]),
ZC24ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1) => (new PIXI.Sprite($1)),
ZC25ZCtestzm0zi3zi0zi0zminplaceZCLibZC: async ($1) => {const texture = await Assets.load($1); return texture},
ZC27ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => (document.querySelector($1).appendChild($2.canvas)),
ZC29ZCtestzm0zi3zi0zi0zminplaceZCLibZC: async ($1,$2,$3) => {const r = await $1.init({background: $2, resizeTo: document.querySelector($3)});
return $1},
ZC31ZCtestzm0zi3zi0zi0zminplaceZCLibZC: ($1,$2) => (new PIXI.Text({text: $1, style: {fill: $2 }})),
ZC32ZCtestzm0zi3zi0zi0zminplaceZCLibZC: () => (new PIXI.Application()),
